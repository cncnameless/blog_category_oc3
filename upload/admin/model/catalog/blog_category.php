...
class ModelCatalogBlogCategory extends Model {
    public function addBlogCategory($data) {
        ...
        // Set which layout to use with this category by store
    ...
    public function getBlogCategories($data = array()) {
        ...
        if (isset($data['sort']) && in_array($data['sort'], array('name', 'sort_order'))) {
    ...
    public function getBlogCategoryDescription($blog_category_id) {
