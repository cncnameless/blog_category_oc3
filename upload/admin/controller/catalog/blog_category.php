...
class ControllerCatalogBlogCategory extends Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . $url));
        }
    ...
    public function repair() {
        ...
        if ($this->validateRepair()) {
            $this->model_catalog_blog_category->repairBlogCategories();
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . $url)
        );

        $data['add'] = $this->url->link('catalog/blog_category/add', 'user_token=' . $this->session->data['user_token'] . $url);
        $data['delete'] = $this->url->link('catalog/blog_category/delete', 'user_token=' . $this->session->data['user_token'] . $url);
        $data['repair'] = $this->url->link('catalog/blog_category/repair', 'user_token=' . $this->session->data['user_token'] . $url);
        ...
        $category_total = $this->model_catalog_blog_category->getTotalBlogCategories();
        ...
        foreach ($results as $result) {
            $data['categories'][] = array(
                ...
                'edit'        => $this->url->link('catalog/blog_category/edit', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] . $url),
                'delete'      => $this->url->link('catalog/blog_category/delete', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] . $url)
            );
        }
        ...
        $data['sort_name'] = $this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url);
        $data['sort_sort_order'] = $this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url);
        ...
        $pagination->url = $this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}');
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['blog_category_id'])) {
            $data['action'] = $this->url->link('catalog/blog_category/add', 'user_token=' . $this->session->data['user_token'] . $url);
        } else {
            $data['action'] = $this->url->link('catalog/blog_category/edit', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $this->request->get['blog_category_id'] . $url);
        }

        $data['cancel'] = $this->url->link('catalog/blog_category', 'user_token=' . $this->session->data['user_token'] . $url);

        if (isset($this->request->get['blog_category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $category_info = $this->model_catalog_blog_category->getBlogCategory($this->request->get['blog_category_id']);
        }
        ...
        if (isset($this->request->post['blog_category_store'])) {
            ...
            $data['blog_category_store'] = $this->model_catalog_blog_category->getBlogCategoryStores($this->request->get['blog_category_id']);
        } else {
        ...
        if (isset($this->request->post['blog_category_layout'])) {
            ...
            $data['blog_category_layout'] = $this->model_catalog_blog_category->getBlogCategoryLayouts($this->request->get['blog_category_id']);
        } else {
